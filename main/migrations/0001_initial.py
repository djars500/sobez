    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('region', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='home.ruraldistrict', verbose_name='Аулды округ')),
            ],
            options={
                'verbose_name': 'Отбасы',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='needy_user', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Заявка',
